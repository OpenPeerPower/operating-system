...
API/UI or by calling `systemctl restart oppos-config` on the host. *The USB Stick just needs to be insterted to the device during this setup process and can be disconnected afterwards.*
...
[debug-openpeerpower]: https://developers.open-peer-power.io/docs/en/oppio_debugging.html
